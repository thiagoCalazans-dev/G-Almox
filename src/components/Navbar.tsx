...
const Navitens = {
  Cadastro: {
    1: {
      name: "Fornecedor",
      href: "/private/cadastro/fornecedor",
    },
    2: {
      name: "Produto",
      href: "/private/cadastro/produto",
    },
  },
  Execução: {
    1: {
  ...
  Relatórios: {
    1: {
      name: "Estoque",
      href: "/private/relatorios/estoque",
    },
  },
};
...
export const Navbar = () => {
  return (
    <div className="w-screen flex justify-between bg-zinc-800 py-4 px-4 ">
          ...
          return (
            <li key={navmenu} className="px-2">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="flex flex-col  w-auto min-w-full absolute right-0 mt-2 origin-top-right rounded-md bg-zinc-700 shadow-lg p-2 ">
